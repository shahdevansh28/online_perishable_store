...
<head>
    ...
    <title>seeMyCart</title>
</head>
<body>
    <div class="topnav" id="myTopnav">
        <a href="customerHome" >Home</a>
        <a href="seeMyCart?userId=${user.userid}" class="active">Cart</a>
    ...
    <table>
        ...
        <tr>
            <td>
                <p>Total Amount : <span class="largeProductPrice">${totalAmount}</span>.00 Rs.</p>
            </td>
            <td></td>
            <td></td>
            <td></td>
            <td>
                <form class="placeOrderForm" action="placeOrder" method="GET">
